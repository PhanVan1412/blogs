      ...
      <div className='grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-2 xl:grid-cols-2 xl:gap-8'>
        <div className='flex flex-col items-center overflow-hidden rounded-lg border md:flex-row'>
          ...
          <div className='flex flex-col gap-2 p-4 lg:p-6'>
            ...
            <p className='text-gray-500'>
              Nghịch cảnh là một phần của cuộc sống. Nó không thể bị kiểm soát. Cái có thể kiểm soát chính là cách chúng
              ta phản ứng trước nghịch cảnh.
            </p>
            <div>
        ...
        <div className='flex flex-col items-center overflow-hidden rounded-lg border md:flex-row'>
          ...
          <div className='flex flex-col gap-2 p-4 lg:p-6'>
            ...
            <p className='text-gray-500'>
              Ai cũng nói tương lai chúng ta luôn rộng mở, nhưng nếu không nắm bắt được hiện tại thì tương lai sẽ chẳng
              có gì.
            </p>
            <div>
              <div className='inline-flex rounded-md shadow-sm' role='group'>
